...
if (discount > 0.5) {
    document.writeln("Втрачена вигода: ", (sum * discount - sum / 2).toFixed(2), "<br \\/>");
} else if (discount < 0.5) {
    document.writeln("Прибуток склав: ", (sum - sum * discount - sum / 2).toFixed(2), "<br \\/>");
} else {
    document.writeln("Товар продано по собівартості", "<br \\/>")
}
